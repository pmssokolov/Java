...
public class DrinkingYogurt extends Yogurt {
    ...
    public DrinkingYogurt(String shelf_life, String amount_of_protein, String fatness, String name,
    ...
    public DrinkingYogurt(String shelf_life, String amount_of_protein, String name,
                  String flavor_additive, int volume, String termination){
        this.shelf_life = shelf_life;
        this.amount_of_protein = amount_of_protein;
        this.flavor_additive = flavor_additive;
